...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ResultCallback<Status> {
    ...
    private void setUpMap() {
        ...
        happyPlace = new MyPlaces("Happy Place", "This is my Happy Place!", new LatLng(25.61937, 85.15402), 100, 10, R.drawable.ic_palm_tree);
        ...
        home = new MyPlaces("Home", "This is where I live.", new LatLng(25.61925, 85.16107), 100, 10, R.drawable.ic_home);
        addPlaceMarker(home);
        addFence(home);

        // Add a place w/o a Geofence
        MyPlaces charleston = new MyPlaces("Charleston, SC", "This is where I want to live!", new LatLng(25.61808, 85.16717), 0, 10, R.drawable.ic_heart);
